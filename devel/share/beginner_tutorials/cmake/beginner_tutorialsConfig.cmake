...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/zach/thesis/src/robocar_node)
  set(beginner_tutorials_DEVEL_PREFIX /home/zach/thesis/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/zach/thesis/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'zach <zach@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zach/thesis/src/robocar_node/${idir}'.  Ask the maintainer 'zach <zach@todo.todo>' to fix it.")
    endif()
